...
export class Backend implements backendInterface {
    ...
    async getFlorenceResponse(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getFlorenceResponse(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listChatSessions(): Promise<Array<ChatSession>> {
        if (this.processError) {
            try {
    ...
    async listTools(): Promise<Array<Tool>> {
        if (this.processError) {
            try {
                const result = await this.actor.listTools();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
